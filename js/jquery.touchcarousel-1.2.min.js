...
(function (f) {
    function q(b, c) {
        ...
        if (this.settings.pagingNav) {
            if (this._j1 = this.settings.snapToItems = !0, this._k1 = Math.ceil(this.numItems / this._i1), this._l1 = 0, this.settings.pagingNavControls) {
                ...
                for (e = 1; e <= this._k1; e++) a = f('<a class="tc-paging-item" href="#">' + e + "</a>").data("tc-id", e), e ===
                    this._l1 + 1 && a.addClass("current"), g.append(a);
        ...
        this.settings.directionNav && (this._n.after("<a href='#' class='arrow-holder left'><span class='arrow-icon left'></span></a> <a href='#' class='arrow-holder right'><span class='arrow-icon right'></span></a>"), this.arrowLeft = this.carouselRoot.find(".arrow-holder.left"),
            this.arrowRight = this.carouselRoot.find(".arrow-holder.right"), 1 > this.arrowLeft.length || 1 > this.arrowRight.length ? this.settings.directionNav = !1 : this.settings.directionNavAutoHide && (this.arrowLeft.hide(), this.arrowRight.hide(), this.carouselRoot.one("mousemove.arrowshover", function () {
            ...
            this.settings.directionNav && (this.arrowRight.click(function (a) {
                a.preventDefault();
        ...
        this.settings.scrollbar ? (this._r1 =
        ...
        this.settings.autoplay &&
            0 < this.settings.autoplayDelay ? (this._x1 = !1, this.autoplayTimer = "", this.wasAutoplayRunning = !0, this.hasTouch || this.carouselRoot.hover(function () {
            d._x1 = !0;
            d._y1()
        }, function () {
            d._x1 = !1;
    ...
    q.prototype = {
        goTo: function (b, c) {
            var a = this.items[b];
            a && (!c && (this.autoplay && this.settings.autoplayStopAtAction) &&
        ...
        updateCarouselSize: function (b) {
            ...
            this.settings.scrollbar && (c = Math.ceil(this._r1.width() / (this._h1 / this.carouselWidth)), this.scrollbarJQ.css("width", c), this._u1 = this._r1.width() -
                c);
            if (!this.settings.scrollToLast) {
                ...
                complete: function () {
                    e ? h._p = f(k).animate(v, {
                        ...
                        complete: function () {
                            ...
                            s[l] = j + Math.round(v.containerPos) +
                                m;
                            p()
                        }
        ...
        _c2: function (b) {
            ...
            return this._w ? (b = b.css("-webkit-transform").replace(/^matrix\(/i, "").split(/, |\)$/g), parseInt(b[4],
        ...
        _n2: function (b) {
            if (this._k2) {
                ...
                if (this.settings.snapToItems) {
                    ...
                    e = this.items[g];
                    this._b2(g);
                    e && (e = d(-e.posX), d = Math.abs(this.endPos - e), b = Math.max(1.08 * d / b, 150), g = Boolean(180 > b), d *= 0.08, a && (d *= -1), this.animateTo(g ? e + d : e, Math.min(b, 400), "easeOutSine", g, e, 300, "easeOutCubic"))
                    ...
                    this._h1 - this.endPos) / b, "easeOutSine", !0, this.carouselWidth - this._h1, 400, "easeOutCubic") : this.animateTo(this.endPos + a, e, "easeOutCubic");
...
(function () {
    if (navigator.userAgent.match(/OS 6(_\d)+/i) && void 0 === window.getTimeouts) {
        var f = {}, q = {}, b = window.setTimeout,
            ...
            d = function (a, d, e, g) {
                if (e) {
                    var l = function () {
                        ...
                        !1 !== k[j].loop ? (k[j].requestededFrame = webkitRequestAnimationFrame(l), k[j].loop = a <= m) : (k[j].callback && k[j].callback(), w ? (m = (new Date).getTime() + d, k[j].loop = a <= m, k[j].requestedFrame = webkitRequestAnimationFrame(l)) : delete k[j])
                    }, j;
                    e = a.name || "rafTimer" +
                ...
                return g ? c(a, d) : b(a, d)
            }, g = function (b, d) {
                if (b.indexOf && -1 < b.indexOf("rafTimer")) {
                    var c;
                    c = d ? q : f;
                    c[b] ? (c[b].callback = void 0, c[b].loop = !1, c = !0) : c = !1;
                    return c
                }
                return d ? e(b) : a(b)
            };
