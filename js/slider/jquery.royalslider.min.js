...
(function (l) {
    function t(b, f) {
        var c, h, a = this, e = navigator.userAgent.toLowerCase();
        a.uid = l.rsModules.uid++;
        a.ns = ".rs" + a.uid;
        var d = document.createElement("div").style, j = ["webkit", "Moz", "ms", "O"], g = "", k = 0;
        ...
        (window.requestAnimationFrame = function (a) {
            var b = (new Date).getTime(), d = Math.max(0, 16 - (b - k)), c = window.setTimeout(function () {
                a(b + d)
            }, d);
            k = b + d;
            return c
        ...
        a._s1 = 0;
        a._e ? (a._t1 = "transition-property", a._u1 = "transition-duration", a._v1 = "transition-timing-function", a._w1 = a._x1 = a._g + "transform", a._f ? (j.webkit && !j.chrome && a.slider.addClass("rsWebkit3d"), a._y1 = "translate3d(", a._z1 = "px, ", a._a2 = "px, 0px)") : (a._y1 = "translate(", a._z1 = "px, ", a._a2 = "px)"), a._l ? a._p1[a._g + a._t1] = a._g + "transform" : (g =
        {}, g[a._g + a._t1] = "opacity", g[a._g + a._u1] = a.st.transitionSpeed + "ms", g[a._g + a._v1] = a.st.css3easeInOut, d.css(g))) : (a._x1 = "left", a._w1 = "top");
        var n;
    ...
    t.prototype = {constructor: t, _i2: function (b) {
        ...
        function c(a, b) {
            ...
            if (j) {
                ...
                var d = a.attr("data-rsw"), c = a.attr("data-rsh");
        ...
        var h = this, a, e = {}, d, j = !0;
        b = l(b);
        h._k2 = b;
        h.ev.trigger("rsBeforeParseNode",
            [b, e]);
        ...
        var d = this, j, g, k = d._z, n = d.numSlides;
        ...
        for (g = m; g < m + 1 + r; g++)if (s = e(g), (j = d.slides[s]) && (!j.isAdded || !j.positionSet)) {
            u = !0;
            break
        }
        for (g = m - 1; g > m - 1 - r; g--)if (s = e(g), (j = d.slides[s]) && (!j.isAdded || !j.positionSet)) {
            t = !0;
            break
        }
        if (u)for (g = m; g < m + q + 1; g++)s = e(g), p = Math.floor((d._u - (m - g)) / d.numSlides) * d.numSlides, (j = d.slides[s]) && c(j, s);
        if (t)for (g = m - 1; g > m - 1 - q; g--)s = e(g), p = Math.floor((d._u - (m - g)) / n) * n, (j = d.slides[s]) && c(j, s);
        if (!b) {
            r = e(m - q);
            m = e(m + q);
            q = r > m ? 0 : r;
            for (g = 0; g < n; g++)if (!(r > m && g > r - 1) && (g < q || g > m))if ((j = d.slides[g]) && j.holder)j.holder.detach(), j.isAdded = !1
        }
        ...
        function h(c, d) {
            if (c.length) {
                var e = c[0];
                if (d !== b.isBig)(e = b.holder.children()) && 1 < e.length && g(); else if (b.iW && b.iH)a(); else if (b.iW = e.width, b.iH = e.height, b.iW && b.iH)a(); else {
                    var f = new Image;
                    f.onload = function () {
        ...
        function e() {
            if (!b.isAppended) {
                var a = k.st.visibleNearby, c = b.id - k._o;
                if (!f && !b.appendOnLoaded && k.st.fadeinLoadedSlide && (0 === c || (a || k._r2 || k._l2) && (-1 === c || 1 === c)))a = {visibility: "visible", opacity: 0}, a[k._g + "transition"] = "opacity 400ms ease-in-out", b.content.css(a), setTimeout(function () {
        ...
        _p2: function (b) {
            ...
            var c = this, h, a = "touchstart" === b.type;
            c._s2 = a;
            ...
            if (c._l2)a && (c._v2 = !0); else {
                ...
                if (a) {
                    ...
                    if (e && 0 < e.length)h = e[0], 1 < e.length && (c._v2 = !0); else return
            ...
            if (this._l3) {
                var c = this._m3, h = b.pageX - this._b3, a = b.pageY - this._c3, e = this._h3 + h, d = this._h3 + a, j = !f ? this._h : this._e3, e = j ? e : d, d = this._z2;
                this._a3 = !0;
                this._b3 = b.pageX;
                this._c3 = b.pageY;
            ...
            var c = this, h, a = "touchmove" === b.type;
            if (!c._s2 || a) {
                if (a) {
                    if (c._r3)return;
                    var e = b.originalEvent.touches;
                ...
                if (c._l3)b.preventDefault(), c._m3 = (new Date).getTime(), c._u3 = h; else if (e = !f ? c._h : c._e3, h = Math.abs(h.pageX - c._b3) - Math.abs(h.pageY - c._c3) - (e ? -7 : 7), 7 < h) {
            ...
            if (!a._s2 || d)if (a._s2 = !1, a.ev.trigger("rsDragRelease"), a._u3 = null, a._l2 = !1, a._r3 = !1, a._l3 = !1, a._m3 = 0, cancelAnimationFrame(a._t3), a._a3 && (f ? a._q3(a._h3) : a._l && a._p3(a._h3)), a._b.off(a._k1).off(a._l1), d && a._e1.off(a._m1), a._i1(),
                !a._a3 && !a._v2 && f && a._w3) {
                ...
                d = a._v;
                var q =
                    a.currSlideId, r = a.numSlides, u = e ? a._f3 : a._g3, t = a._z;
                Math.abs(m - p);
                e = m - d;
                d = (new Date).getTime() - a._j3;
                d = Math.abs(e) / d;
                if (0 === u || 1 >= r)h(!0, d); else {
                    if (!t && !f)if (0 >= q) {
                        if (0 < u) {
                            h(!0, d);
                            return
            ...
            j = Math.abs(j);
            var p = Math.floor(g / e._y), q = Math.floor((g + (m ? k : -k)) / e._y), p = (m ? Math.max(p, q) : Math.min(p, q)) * e._y + (m ? e._y - 1 : 0);
            ...
            function e() {
                var a;
                if (j && (a = j.data("rsTimeout")))j !== g && j.css({opacity: 0, display: "none", zIndex: 0}), clearTimeout(a), j.data("rsTimeout", "");
            ...
            }, 20))) : d._l ? (k[d._h ? d._x1 : d._w1] = b + "px", d._p1.animate(k, d._c, h ? d.st.easeInOut : d.st.easeOut)) : (j = d._h4, g = d._r1, g.stop(!0, !0).css({opacity: 0, display: "block", zIndex: d._m}), d._c = d.st.transitionSpeed, g.animate({opacity: 1}, d._c, d.st.easeInOut), e(), j && j.data("rsTimeout", setTimeout(function () {
                j.stop(!0,
                    !0).css({opacity: 0, display: "none", zIndex: 0})
            }, d._c + 60)));
            d._r2 = !0;
            ...
            if (this._l)if (this._e) {
                ...
                10); else 20 < this._m ? this._m = 10 : this._m++
        }, _m4: function () {
        ...
        _j4: function (b, f) {
            ...
            if (!b.isRendered) {
                var f = b.content, c = "rsMainSlideImage", h, a = this.st.imageAlignCenter, e = this.st.imageScaleMode, d;
                b.videoURL && (c = "rsVideoContainer", "fill" !== e ? h = !0 : (d = f, d.hasClass(c) || (d = d.find("." + c)), d.css({width: "100%",
                    height: "100%"}), c = "rsMainSlideImage"));
                ...
                if (f) {
                    ...
                    if ("none" !== e || a) {
                        ...
                        "none" !== e && (l.width = j, l.height = c, h && f.find(".rsImg").css({width: "100%", height: "100%"}));
    ...
    l.extend(jQuery.easing, {easeInOutSine: function (b, f, c, h, a) {
...
(function (j) {
    j.extend(j.rsProto, {_q4: function () {
        function l() {
            var f = a.currSlide;
            if (a.currSlide && a.currSlide.isLoaded && a._u4 !== f) {
                ...
                if (0 < a._s4.length) {
                    var e;
                    for (b = 0; b < a._s4.length; b++)if (e = a._s4[b])a._e ? (e.block.css(a._g + a._u1, "0s"), e.block.css(e.css)) : e.block.stop(!0).css(e.css), a._u4 = null, f.animBlocksDisplayed = !1;
                    a._s4 = []
                }
    ...
    b.extend(b.rsProto, {_x4: function () {
        ...
        if (a.st.autoHeight) {
            var b, d, e, c = function (c) {
                ...
                if (b = e.holder)if ((d = b.height()) && void 0 !== d)a._c4 = d, a._e || !c ? a._e1.css("height", d) : a._e1.stop(!0, !0).animate({height: d}, a.st.transitionSpeed)
            };
...
(function (b) {
    b.extend(b.rsProto, {_y4: function () {
        var a = this, d;
        a._z4 = {enabled: !1, stopAtAction: !0, pauseOnHover: !0, delay: 2E3};
...
(function (c) {
    c.extend(c.rsProto, {_j5: function () {
        var a = this;
        "bullets" === a.st.controlNavigation && (a.ev.one("rsAfterPropsSetup", function () {
            ...
            a._l5.on("click.rs", ".rsNavItem", function () {
...
(function (b) {
    b.extend(b.rsProto, {_p5: function () {
        var a = this, g, c, e;
        a._q5 = {enabled: !1, change: !1, prefix: ""};
...
(function (c) {
    c.extend(c.rsProto, {_r5: function () {
        var a = this;
        a._s5 = {enabled: !1, keyboardNav: !0, buttonFS: !0, nativeFS: !1, doubleTap: !0};
        ...
        if (a.st.fullscreen.nativeFS) {
            a._v5 = {supportsFullScreen: !1, isFullScreen: function () {
                return!1
            ...
            if (!a.isAndroid)if ("undefined" != typeof document.cancelFullScreen)a._v5.supportsFullScreen = !0; else for (var d = 0; d < b.length; d++)if (a._v5.prefix = b[d], "undefined" != typeof document[a._v5.prefix + "CancelFullScreen"]) {
        ...
        a.st.fullscreen.buttonFS && (a._w5 = c('<div class="rsFullscreenBtn"><div class="rsFullscreenIcn"></div></div>').appendTo(a._o1).on("click.rs", function () {
            a.isFullscreen ? a.exitFullscreen() : a.enterFullscreen()
        }))
    },
        enterFullscreen: function (a) {
            var b = this;
            if (b._v5)if (a)b._v5.requestFullScreen(c("html")[0]); else {
...
(function (b) {
    b.extend(b.rsProto, {_f6: function () {
        var a = this;
...
(function (e) {
    e.extend(e.rsProto, {_g6: function () {
        var a = this;
...
(function (f) {
    f.extend(f.rsProto, {_i6: function () {
        var a = this;
        "thumbnails" === a.st.controlNavigation && (a._j6 = {drag: !0, touch: !0, orientation: "horizontal", navigation: !0, arrows: !0, arrowLeft: null, arrowRight: null, spacing: 4, arrowsAutoHide: !1, appendSpan: !1, transitionSpeed: 600, autoCenter: !0, fitInViewport: !0, firstMargin: !0, paddingTop: 0, paddingBottom: 0}, a.st.thumbs = f.extend({}, a._j6, a.st.thumbs), a._k6 = !0, !1 === a.st.thumbs.firstMargin ? a.st.thumbs.firstMargin = 0 : !0 === a.st.thumbs.firstMargin && (a.st.thumbs.firstMargin =
        ...
        var a = this, e = a._m5.first(), c = {}, b = a._m5.length;
        ...
        if (a._y3 < a._z3)a.st.thumbs.autoCenter && a._q3((a._z3 - a._y3) / 2), a.st.thumbs.arrows && a._s6 && (a._s6.addClass("rsThumbsArrowDisabled"), a._t6.addClass("rsThumbsArrowDisabled")), a._m6 = !1, a._n5 = !1, a._l5.off(a._j1); else if (a.st.thumbs.navigation && !a._m6 && (a._m6 = !0, !a.hasTouch && a.st.thumbs.drag ||
        ...
        var c = 0, b, f = a * this._u6 + 2 * this._u6 - this._w6 + this._n3, d = Math.floor(this._i3 / this._u6);
...
(function (f) {
    f.extend(f.rsProto, {_a7: function () {
        ...
        if (!a._c7) {
            ...
            var b = a._e7 = c.content, c = c.videoURL, e, d;
            ...
            a.videoObj.length && (a._d7 = f('<div class="rsVideoFrameHolder"><div class="rsPreloader"></div><div class="rsCloseVideoBtn"><div class="rsCloseVideoIcn"></div></div></div>'), a._d7.find(".rsPreloader").after(a.videoObj), b = b.hasClass("rsVideoContainer") ? b : b.find(".rsVideoContainer"), a._d7.css({width: b.width(),
                height: b.height()}).find(".rsCloseVideoBtn").off("click.rsv").on("click.rsv", function (b) {
                    a.stopVideo();
                    b.preventDefault();
                    b.stopPropagation();
                    return!1
